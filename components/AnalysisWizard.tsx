        ...
        <div className="space-y-6 animate-fadeIn">
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-gray-800 text-indigo-300 border border-gray-700">
                      {m.badge}
                    </span>
                  </div>
          ...
          <div className="flex items-center justify-between pt-4 border-t border-gray-700/60">
            ...
            <button
              ...
              disabled={isLoading || (mode === 'visual' && !image)}
              className="px-8 py-3.5 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white font-extrabold rounded-full text-base transition-all duration-300 shadow-xl hover:shadow-indigo-500/30 flex items-center gap-2.5 transform hover:scale-105 disabled:scale-100 disabled:opacity-60"
            >
